...
def setup_migrations():
    ...
    env_content = '''from __future__ import with_statement
...
'''
    ...
    print("\nMigrations directory has been set up successfully!")
    print("\nNext steps:")
    print("1. Run: python -m flask db migrate -m 'initial migration'")
